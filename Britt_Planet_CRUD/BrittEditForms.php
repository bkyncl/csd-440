...
display the entire 'planets' table and allows users to delete or update planets via ID# with "delete" or "edit" form button
...
Key Components:
    ...
    - Displays the 'planets' table with options to delete or update planets.
-->
<?php
...
$urlalertClass = isset($_GET['alertClass']) ? urldecode($_GET['alertClass']) : "";
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($tableContentOrError) && strpos($tableContentOrError, "Error:") === false): ?>
                                <div class="mb-3 text-center">
                                    ...
                                    <div class="text-center">
                                        <h6 class="card-title">Edit or Delete Planets</h6>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Dwarf Planet</th>
                                                    <th colspan="2">Action</th> <!-- Column for Actions -->
                                                </tr>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="text-center" style="padding: 10px;">
                                    ...
                                    <?php if (!empty($responseMessage)): ?>
                                        <div class="alert <?php echo $alertClass; ?>"><?php echo $responseMessage; ?></div>
                                    <?php elseif (!empty($successMessage)) : ?>
                                        <div class="alert <?php echo $urlalertClass; ?>"><?php echo $successMessage; ?></div>
                                    <?php endif ?>
                                </div>
                            <?php else: ?>
                                <div class="text-center">
