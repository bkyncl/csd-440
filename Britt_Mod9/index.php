...
dropping, population, and queries. It incorporates user-friendly interface elements using Bootstrap for styling and navigation bar to other pages.
Key Components:
    ...
    - Inlcusion of db connect file that contains the db connection function.
